...
import { scheduleAdaptivePolling, scheduleConnectionCanary, scheduleDormancySweep, scheduleMailPollSweep, scheduleReconciliation, scheduleTriggerTick, scheduleWatchRenewal, startWorkers } from "./infra/queues.js";
...
void scheduleAdaptivePolling().catch((e) => getLogger().error({ err: e }, "failed to schedule adaptive polling"));
void scheduleReconciliation().catch((e) => getLogger().error({ err: e }, "failed to schedule reconciliation"));
